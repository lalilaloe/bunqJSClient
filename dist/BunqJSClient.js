...
const CardDebit_1 = require("./Api/CardDebit");
...
const AttachementPublic_1 = require("./Api/AttachementPublic");
...
class BunqJSClient {
    ...
    constructor(storageInterface = store, loggerInterface = Logger_1.default) {
        ...
        this.api = {
            ...
            attachmentPublic: new AttachementPublic_1.default(this.ApiAdapter),
            bunqMeTabs: new BunqMeTabs_1.default(this.ApiAdapter),
            card: new Card_1.default(this.ApiAdapter),
            cardDebit: new CardDebit_1.default(this.ApiAdapter),
